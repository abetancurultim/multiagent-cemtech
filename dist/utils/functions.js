...
export async function sendQuoteToWhatsApp(quoteUrl, phoneNumber) {
...
export async function fetchUserName(firstNumber) {
...
export async function sendEmailNotification(name, phone, message) {
...
;
export async function sendSoftwareSpecialistNotification(name, phone, message) {
    const transporter = nodemailer.createTransport({
        host: "smtp.sendgrid.net",
        port: 587,
        auth: {
