...
export const searchFAQTool = tool(
  ...
  },
  {
    name: "search_faq",
    description:
      "Busca respuestas en la base de conocimientos de preguntas frecuentes por categoría y palabras clave.",
    schema: z.object({
      query: z
        .string()
        .min(3)
        .describe(
          "Pregunta o palabras clave a buscar en la base de conocimientos"
        ),
      category: z
...
export const trackOrderTool = tool(
  async (params: { orderId: string; customerInfo?: string }) => {
  ...
  },
  {
    name: "track_order",
    description:
      "Rastrea el estado de una orden y proporciona información detallada sobre envío e instalación.",
    schema: z.object({
      orderId: z
        .string()
        .min(1)
 ...
 */
export const manageComplaintTool = tool(
  async (params: {
    customerName: string;
  ...
  },
  {
    ...
    description:
      "Gestiona reclamos de clientes creando casos de seguimiento con tiempos de resolución definidos.",
    schema: z.object({
      customerName: z
        .string()
        .min(2)
...
export const getCompanyInfoTool = tool(
  ...
  },
  {
    ...
    description:
      "Obtiene información general de InduEquipos Andina S.A.S. incluyendo contacto, productos y servicios.",
    schema: z.object({
      infoType: z
        .enum(["contacto", "productos", "general"])
        .optional()
        .describe(
          "Tipo específico de información requerida. Si no se especifica, devuelve información completa"
        ),
    }),
  }
);
...
export const scheduleFollowUpTool = tool(
  ...
  },
  {
    ...
    description:
      "Programa llamadas de seguimiento con clientes para verificar satisfacción o resolver consultas adicionales.",
    schema: z.object({
...
export const validateCityTool = tool(
  ...
  },
  {
    ...
    description:
      "Valida si una ciudad está dentro de la cobertura de servicio de InduEquipos Andina S.A.S.",
    schema: z.object({
      city: z
        .string()
        .min(2)
 ...
 */
export const contactServiceTool = tool(
  async () => {
  ...
  },
  {
    ...
    description:
      "Obtiene información de contacto especializada para ventas y servicios de InduEquipos Andina S.A.S.",
    schema: z.object({}),
  }
);
