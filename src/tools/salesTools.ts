 ...
 */
export const getProductCatalogTool = tool(
  async (params: {
    category?: string;
    minPrice?: number;
    maxPrice?: number;
  ...
  },
  {
    ...
    description:
      "Obtiene el catálogo completo de productos disponibles para venta con filtros opcionales por categoría, precio y disponibilidad.",
    schema: z.object({
      category: z
        .enum([
          "panaderia",
...
export const calculateQuoteTool = tool(
  ...
  },
  {
    ...
    description:
      "Calcula una cotización detallada para productos específicos con descuentos automáticos según tipo de cliente y cantidad.",
    schema: z.object({
      productId: z
        .string()
        .min(1)
...
export const getSalesAnalyticsTool = tool(
  ...
  },
  {
    ...
    description:
      "Proporciona análisis de ventas y tendencias del mercado por período y categoría de productos.",
    schema: z.object({
      timeframe: z
...
export const getActivePromotionsTool = tool(
  ...
  },
  {
    ...
    description:
      "Obtiene las promociones y descuentos activos por categoría de productos.",
    schema: z.object({
      category: z
        .enum([
          "panaderia",
...
export const checkInventoryTool = tool(
  ...
  },
  {
    ...
    description:
      "Verifica la disponibilidad de inventario para productos específicos o general.",
    schema: z.object({
      productId: z
        .string()
        .optional()
        .describe(
          "ID específico del producto a consultar. Si no se proporciona, muestra inventario general"
        ),
    }),
  }
);
