...
} from "../functions/technicalFunctions";
 ...
 */
export const diagnoseTechnicalIssueTool = tool(
  async (params: {
  ...
  },
  {
    ...
    description:
      "Diagnostica problemas técnicos con productos y proporciona soluciones paso a paso basado en síntomas y palabras clave.",
    schema: z.object({
      issueDescription: z
        .string()
        .min(5)
 ...
 */
export const scheduleTechnicalVisitTool = tool(
  async (params: {
    customerName: string;
  ...
  },
  {
    ...
    description:
      "Programa visitas técnicas para instalación, mantenimiento o reparación de equipos con técnicos especializados.",
    schema: z.object({
 ...
 */
export const getTechnicalManualTool = tool(
  async (params: {
    productModel: string;
    manualType?: string;
    language?: string;
  ...
  },
  {
    ...
    description:
      "Obtiene información técnica detallada y manuales de productos específicos por modelo.",
    schema: z.object({
      productModel: z
        .string()
        .min(1)
 ...
 */
export const checkWarrantyStatusTool = tool(
  async (params: {
    productId: string;
    serialNumber?: string;
    purchaseDate?: string;
  ...
  },
  {
    ...
    description:
      "Verifica el estado de garantía de un producto, incluyendo vigencia, cobertura y próximos pasos.",
    schema: z.object({
...
export const schedulePreventiveMaintenanceTool = tool(
  ...
  },
  {
    ...
    description:
      "Programa mantenimiento preventivo para equipos para extender su vida útil y prevenir fallas imprevistas.",
    schema: z.object({
      productId: z
        .string()
        .min(1)
