...
export const contactTool = tool(
  ...
  },
  {
    ...
    description:
      "Brinda el canal de contacto para ventas y servicios de InduEquipos Andina S.A.S.",
    schema: z.object({}),
  }
);
...
export const getProductInfoTool = tool(
  ...
  },
  {
    ...
    description:
      "Obtiene información sobre un producto específico de InduEquipos Andina S.A.S. Usa esta herramienta solo cuando el cliente pregunte por un producto específico.",
    schema: z.object({
      product: z
        .union([
          z.literal("cámara"),
...
export const troubleshootIssueTool = tool(
  ...
  },
  {
    ...
    description:
      "Brinda soluciones a problemas comunes con los productos de InduEquipos Andina S.A.S.",
    schema: z.object({
 ...
 */
export type ProductType = "cámara" | "alarma" | "cerca eléctrica";

/**
 * Estructura de herramientas generales
 */
export interface GeneralToolsInterface {
  contactTool: typeof contactTool;
  getProductInfoTool: typeof getProductInfoTool;
  troubleshootIssueTool: typeof troubleshootIssueTool;
  validateCityTool: typeof validateCityTool;
}
